<?php 
class Application_Form_Profile_Profile extends Zend_Form {
	...
	public function __construct() {
		...
		$this->setAction($view->baseUrl('profile/edit'));
		$this->setMethod('post');
		...
		$email->setDecorators(array('ViewHelper', new Site_Form_Decorator_Profile_Text()));
		...
		$telephone->setDecorators(array('ViewHelper', new Site_Form_Decorator_Profile_Text()));
		...
		$skype->setDecorators(array('ViewHelper', new Site_Form_Decorator_Profile_Text()));
		...
		$day->setDecorators(array('ViewHelper', new Site_Form_Decorator_Profile_Date_Day()));
		...
		$month->setDecorators(array('ViewHelper', new Site_Form_Decorator_Profile_Date_Month()));
		...
		$year->setDecorators(array('ViewHelper', new Site_Form_Decorator_Profile_Date_Year()));
		...
		$city->setDecorators(array('ViewHelper', new Site_Form_Decorator_Profile_Text()));
		...
		$height->setDecorators(array('ViewHelper', new Site_Form_Decorator_Profile_Text()));
		...
		foreach($options as $option) {
			if($option['type'] == 'select') {
				...
				$newSelect->setDecorators(array('ViewHelper', new Site_Form_Decorator_Profile_Text()));
				...
				$newCheckbox->setDecorators(array('ViewHelper', new Site_Form_Decorator_Profile_Checkbox()));
		...
		$user = $db_user->getUser($view->user->user_id);
		...
		if(isset($st['languages'])) {
			...
			$languageCount = count($db_user->getLanguagesByUserId($view->user->user_id));
		...
		$step2->setDecorators(array('FormElements',	new Site_Form_Decorator_Profile_Step()));
		...
		$step3->setDecorators(array('FormElements',	new Site_Form_Decorator_Profile_Step()));
