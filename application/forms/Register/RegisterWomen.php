<?php 
class Application_Form_Register_RegisterWomen extends Zend_Form {
	...
	public function __construct() {
		...
		$women = new Zend_Form_Element_Hidden('women');
		$women->setDecorators(array('ViewHelper', new Site_Form_Decorator_Women()));
		...
		$submit->setAttrib('action', $view->baseUrl('register/registerwomen'));
		
		$this->addElements(array($email, $password, $password_confirm, $women, $captcha, $submit));
	}
}